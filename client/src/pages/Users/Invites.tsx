...
import PaginatedTable from "../UiElements/PaginatedTable"; // adjust path based on your folder structure
    ...
    <div className="p-6 bg-white dark:bg-gray-900 rounded-xl shadow w-full">
      ...
      <PaginatedTable
        ...
        columns={[
          ...
          {
            label: "Position",
            render: (invite) => invite.position,
          },
          {
            label: "Organization",
            render: (invite) =>
              organizations.find((o) => o.id === invite.organization_id)
                ?.name ?? "N/A",
          },
          {
            label: "Status",
